...
/**
 * Logging facility provided by the Pulley. This logs to the
 * pulley's configured loggers, using @p logname as the name
 * of the logger (recommended is steamworks.pulleyback.<name>),
 * and logs the @p message at debug level.
 *
 * Note that this function is *not* part of the API of the
 * plugin: it is API provided *to* the plugin.
 */
